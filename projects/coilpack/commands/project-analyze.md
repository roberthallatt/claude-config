...
### 2. Template Structure (Coilpack)

Scan for templates:
- ExpressionEngine: `ee/system/user/templates/`
...
Scan for:
- EE add-ons in `ee/system/user/addons/`
- Laravel packages in `composer.json`
- MCP addon
...
- Livewire detected → confirm livewire commands available
- No security agent → suggest adding security-expert
- API routes → suggest api-design-specialist
